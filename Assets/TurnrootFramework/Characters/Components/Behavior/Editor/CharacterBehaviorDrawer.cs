...
public class CharacterBehaviorDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        InfoBoxText = GetPresetInfoBoxText((CharacterBehaviorPresetEnum)presetProp.enumValueIndex);
    ...
    private string GetPresetInfoBoxText(CharacterBehaviorPresetEnum presetEnum)
    {
        switch (presetEnum)
        {
            case CharacterBehaviorPresetEnum.MindlessBerserker:
                return "Mindlessly attacks nearby enemies without regard for self-preservation";
            case CharacterBehaviorPresetEnum.CunningAssassin:
                return "Cautiously works alone to eliminate strategic enemies.";
            case CharacterBehaviorPresetEnum.GreedyCoward:
                return "Avoids combat, prefers looting and running away.";
            case CharacterBehaviorPresetEnum.LoyalGuardian:
                return "Stays near to allies and keeps them safe, even above their own safety";
            case CharacterBehaviorPresetEnum.WaryProtector:
                return "Prioritizes defense of allies while avoiding unnecessary risks";
            case CharacterBehaviorPresetEnum.VengefulWarrior:
                return "Generally strategic, flies into a murderous rampage when allies are killed";
            case CharacterBehaviorPresetEnum.RecklessDuelist:
                return "Seeks out enemies without considering themselves or allies";
            case CharacterBehaviorPresetEnum.BalancedVeteran:
                return "A well-rounded fighter who balances risks and support";
            default:
                return string.Empty;
        }
    }
    ...
    private void ApplyPreset(SerializedProperty property, SerializedProperty presetProp)
    {
        ...
        property.FindPropertyRelative("SoldierLoneWolf").floatValue = presetValues.SoldierLoneWolf;
        property.FindPropertyRelative("MindlessCunning").floatValue = presetValues.MindlessCunning;
        property.FindPropertyRelative("SelfishSelfless").floatValue = presetValues.SelfishSelfless;
