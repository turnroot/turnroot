...
namespace Turnroot.Characters
{
    ...
    public class CharacterInstance : Serialization.IPostDeserialize, IHasStats
    {
        ...
        /// </summary>
        public bool RemoveStatusEffect(StatusEffectInstance effect) => _activeStatusEffects.Remove(effect);

        /// <summary>
        /// Remove all status effects of a specific type.
        /// </summary>
        public int RemoveStatusEffectsByType(StatusEffectType effectType) => _activeStatusEffects.RemoveAll(e => e.EffectType == effectType);

        /// <summary>
        /// Remove all buffs from this character.
        /// </summary>
        public int RemoveAllBuffs() => _activeStatusEffects.RemoveAll(e => e.EffectType?.IsBuff == true);

        /// <summary>
        /// Remove all debuffs from this character.
        /// </summary>
        public int RemoveAllDebuffs() => _activeStatusEffects.RemoveAll(e => e.EffectType?.IsDebuff == true);
        ...
        /// </summary>
        public bool HasStatusEffect(StatusEffectType effectType) => _activeStatusEffects.Exists(e => e.EffectType == effectType);
        ...
        /// </summary>
        public bool HasAnyDebuff() => _activeStatusEffects.Exists(e => e.EffectType?.IsDebuff == true);
        ...
        {
            return !string.IsNullOrEmpty(effectName) && _activeStatusEffects.Exists(e =>
                e.EffectType != null
                && (
                    e.EffectType.DisplayName?.Equals(effectName, StringComparison.OrdinalIgnoreCase)
                        == true
        ...
        /// </summary>
        public bool IsMovementPrevented() => _activeStatusEffects.Exists(e => e.EffectType?.PreventsMovement == true);

        /// <summary>
        /// Check if attack is prevented by any status effect.
        /// </summary>
        public bool IsAttackPrevented() => _activeStatusEffects.Exists(e => e.EffectType?.PreventsAttack == true);

        /// <summary>
        /// Check if item use is prevented by any status effect.
        /// </summary>
        public bool IsItemUsePrevented() => _activeStatusEffects.Exists(e => e.EffectType?.PreventsItemUse == true);
