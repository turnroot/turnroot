...
public class FlowSegmentDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded)
        {
            ...
            EditorGUI.PropertyField(eventRect, onSegmentReachedProperty, new GUIContent("On Segment Reached"), true);
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        return (EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing) * 2 + eventHeight;
    }
}
