...
namespace Turnroot.Gameplay.Maps
{
    ...
    public class MapGridPointFeaturePropertiesEditor : UnityEditor.Editor
    {
                ...
                AddProperty(
                    ...
                    () =>
                        src.boolProperties.Add(
                            new MapGridPropertyBase.BoolProperty { key = "new_bool", value = false }
                        )
                );
            }
                ...
                AddProperty(
                    ...
                    () =>
                        src.floatProperties.Add(
                            new MapGridPropertyBase.FloatProperty { key = "new_float", value = 0f }
                        )
                );
            }
        ...
        private void DrawRemainingProperties()
        {
            ...
            {
                enterChildren = false;
                if (prop.name is "featureId" or "featureName")
                {
                    continue;
                }
